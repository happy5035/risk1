    ...
    cellspacing="0" cellpadding="0" height="27">
        <tr>
          ...
          <td width="47%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
					<td width="100%" class="f3">项目管理>>修改项目信息</td>
                </tr>
            </table></td>
          <td width="50%"></td>
        </tr>
...
<table width="50%" border="0" cellspacing="1" cellpadding="3" align="center">
	<tr>
		<td align="center" class="tr4"> 
			...
			<%-- <tr class="tr2">
					<td  class="tr1" align="right">*项目类型:</td>									
					<td>
					...
					<td  class="tr1" align="right" >*项目等级判定依据:</td>	
					<td>								
			...
			<tr class="tr2">	
					<td  class="tr1" align="right" >*项目发生时间:</td>
